...
<div class="section">
  <div class="esc">
    ...
    <div class="doc">
      <!-- Top Nav -->
      <h1>Font Icons</h1>
      <p class="lead">Font Icons are scalable visual elements that can be used to improve complex user interfaces.</p>
      
      <hr>

      <h3>Font Awesome Icons</h3>
      <p>We love the 605 available font icons over at <a href="https://fortawesome.github.io/Font-Awesome">Font Awesome</a>. We import the full icon family using MaxCDN, view the full list of icons <a href="https://fortawesome.github.io/Font-Awesome/icons/">here</a>.</p>
      ...
      <h3>GitHub</h3>
      <p>Take a look at this components <b>SASS</b> file on <a href="https://github.com/gmrgo/gmrui/blob/gh-pages/scss/gmrui/_fonts.scss">GitHub</a>.</p>
